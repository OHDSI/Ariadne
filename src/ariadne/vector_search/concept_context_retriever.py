...
def add_concept_context(
    ...
    """
    Adds concept context (parents, children, synonyms) to the given concept table. Multiple entries per concept will be
    concatenated with semicolons. Children are limited to 10 random entries per concept.
